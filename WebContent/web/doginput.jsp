									...
									<div class="mainmenu">
										<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
											<ul class="nav navbar-nav">
												<li><a href="web_page/index.html">메인</a></li>
												<li><a href="web_page/about.html">소개</a></li>
												<li><a href="web_page/mypage.html">강아지매니징</a></li>
												<li><a href="web_page/dog.html">애견사전</a></li>
												<li><a href="web_page/board.html">커뮤니티</a></li>
											</ul>
										</div>
									</div>
									<div class="member">
                                        <h4><a href="web_page/signin.html#signin"><span class="label label-primary">Sign in</span></a></h4>
                                        <h4><a href="web_page/signin.html#signup"><span class="label label-success">Sign up</span></a></h4>
									</div>
								</div>
							</div>
							<!-- /.navbar-collapse -->
