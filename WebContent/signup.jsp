                    ...
                    <div>
                        <div style="display: flex; justify-content: space-around;">
                            ...
                            <div>
                                ...
                                <button class="label label-primary" onclick="location='signup.jsp'" style="margin-top:.5em; padding-bottom:0em;"><h4>Sign up</h4></button>
                            </div>
                        </div>
                    </div>
                </nav>
            ...
            <div class="content">
                <div class="signin-cont cont">
                    <form action="UserServlet" method="POST" enctype="multipart/form-data">
                        ...
                        <input type="password" name="comfirmedpassword" id="comfirmedpassword" class="inpt" required="required" placeholder="Your comfirmed password">
